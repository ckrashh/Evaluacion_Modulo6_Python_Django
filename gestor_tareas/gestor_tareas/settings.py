...
SECRET_KEY = 'django-insecure-rdkfxgeda!mq5!1tm3v9mvy+d26%*+80z&&8ia+_3jkbl%@%c-'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = []
#ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'gestor-tareas.cl', 'www.gestor-tareas.cl']
#ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', 'localhost,127.0.0.1,gestor-tareas.cl').split(',')
